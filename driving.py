...
class Driving(Itinerary):
    ...
    __URL_API_DIRECTION_Transit = 'https://maps.googleapis.com/maps/api/directions/json?&key=AIzaSyATrZmC9-XjaEAdwtPw6RG0QWV65dbywe0&mode=driving&alternatives=true'
...
if __name__ == "__main__":
    ...
    voyage = driving("10 rue oswaldo cruz paris 75016", "Favella Chic Paris", "walking")
