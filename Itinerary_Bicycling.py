...
class Bicycling(Itinerary):
    ...
    def __init__(self, origin, destination, transport_mode, date=None, transit_mode_type=None, itinerary_index=0):
        ...
        if self.transport_mode == "bicycling":
            ...
            for step_number, step in enumerate(steps):
                ...
                if information_legs[step_number]['transport_mode'] == "BICYCLING":
                    self._bicycling_distance += step['distance']['value']
                    self._bicycling_duration += step['duration']['value']
                else:
